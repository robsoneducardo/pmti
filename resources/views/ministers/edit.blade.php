...
@section('breadcrumbs', Breadcrumbs::render('ministers.edit', $minister))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2>@lang('app.edit.title', ['id' => $minister->id])</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('ministers.update', ['minister' => $minister]) }}" method="post" name="edit">
                        @method('patch')
                        @csrf
