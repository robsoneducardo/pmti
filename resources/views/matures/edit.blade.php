...
@section('breadcrumbs', Breadcrumbs::render('matures.edit', $mature))
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2>@lang('app.edit.title', ['id' => $mature->id])</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('matures.update', ['mature' => $mature]) }}" method="post" name="edit">
                        @method('patch')
                        @csrf
...
@endpush
    ...
    <select id="district_id" type="number" class="form-control" name="district_id">
