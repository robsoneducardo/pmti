...
@section('breadcrumbs', Breadcrumbs::render('activities.create'))
...
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2>@lang('app.create.title', ['model' => __('activities.model')])</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('activities.store') }}" method="post" name="create">
                        @csrf
    ...
    @endif
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-outline-dark" onclick="location.href='{{ route('activities.index') }}'">@lang('app.cancel')</button>
                        </div>
                    </form>
                </div>
            </div>
